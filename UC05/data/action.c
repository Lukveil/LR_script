Action()
{
	...
	lr_start_transaction("UC05_TR11_click save");
	...
	web_url("11198", 
		"URL=https://dev-boomq.pflb.ru/report-srv/report/11198", 
		"Resource=0", 
		"RecContentType=application/json", 
	...
	web_url("content", 
		"URL=https://dev-boomq.pflb.ru/report-srv/report/11198/content", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://dev-boomq.pflb.ru/account/reports/11198", 
		"Snapshot=t21.inf", 
	...
	lr_end_transaction("UC05_TR11_click save",LR_AUTO);

	lr_start_transaction("UC05_TR666_get_back");
	...
	lr_end_transaction("UC05_TR666_get_back",LR_AUTO);

	lr_think_time(5);

	lr_start_transaction("UC05_TR999_pick_created");
	...
	lr_end_transaction("UC05_TR999_pick_created",LR_AUTO);
