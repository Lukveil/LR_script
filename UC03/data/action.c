Action()
{
	...
	lr_end_transaction("tests",LR_AUTO);

	lr_think_time(38);

	lr_start_transaction("Run_thr_group");

	web_url("25116", 
		"URL=https://dev-boomq.pflb.ru/project-srv/project/25116", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://dev-boomq.pflb.ru/account/tests/25116", 
		"Snapshot=t37.inf", 
		"Mode=HTML", 
		LAST);

	web_url("25320", 
		"URL=https://dev-boomq.pflb.ru/project-srv/project/25116/version/25320", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://dev-boomq.pflb.ru/account/tests/25116", 
	...
	web_url("downloadLink", 
		"URL=https://dev-boomq.pflb.ru/project-srv/project/25116/version/25320/downloadLink", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://dev-boomq.pflb.ru/account/tests/25116", 
	...
	web_custom_request("test", 
		...
		"Body={\"comment\":\"\",\"labelSet\":[],\"projectId\":\"25116\",\"projectVersionId\":25320,\"testMode\":\"TEST\",\"testProjectId\":\"25116\",\"testProjectVersionId\":25320}", 
		LAST);
	...
	lr_end_transaction("Run_thr_group",LR_AUTO);

	lr_think_time(32);

	lr_start_transaction("Run_jmx");
	...
	web_url("15095", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://dev-boomq.pflb.ru/account/tests/15095", 
		"Snapshot=t48.inf", 
		"Mode=HTML", 
		LAST);

	web_url("25322", 
		"URL=https://dev-boomq.pflb.ru/project-srv/project/15095/version/25322", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://dev-boomq.pflb.ru/account/tests/15095", 
	...
	web_url("downloadLink_2", 
		"URL=https://dev-boomq.pflb.ru/project-srv/project/15095/version/25322/downloadLink", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://dev-boomq.pflb.ru/account/tests/15095", 
		...
		"Mode=HTML", 
		EXTRARES, 
		"Url=/minio/boomq/boomq/teams/14/projects/15095/v_25322.yaml?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAIOSFODNN7EXAMPLE/20240828/us-east-1/s3/aws4_request&X-Amz-Date=20240828T104120Z&X-Amz-Expires=604800&X-Amz-SignedHeaders=host&X-Amz-Signature=6d9c152e4ef322be6b35291ca0bae5a51e22fd8c48ab86bbf12d7c706aef0288", "Referer=https://dev-boomq.pflb.ru/account/tests/15095", ENDITEM, 
		LAST);
	...
	web_custom_request("test_4", 
		...
		"Mode=HTML", 
		"EncType=application/json", 
		"Body={\"comment\":\"\",\"labelSet\":[],\"projectId\":\"15095\",\"projectVersionId\":25322,\"testMode\":\"TEST\",\"testProjectId\":\"15095\",\"testProjectVersionId\":25322}", 
		LAST);
	...
	lr_end_transaction("Run_jmx",LR_AUTO);
