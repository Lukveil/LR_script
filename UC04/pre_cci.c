# 1 "c:\\users\\user\\documents\\vugen\\scripts\\for performance testing\\uc04\\\\combined_UC04.c"
...
# 1 "c:\\users\\user\\documents\\vugen\\scripts\\for performance testing\\uc04\\\\combined_UC04.c" 2
...
# 2 "c:\\users\\user\\documents\\vugen\\scripts\\for performance testing\\uc04\\\\combined_UC04.c" 2
...
# 3 "c:\\users\\user\\documents\\vugen\\scripts\\for performance testing\\uc04\\\\combined_UC04.c" 2
...
# 4 "c:\\users\\user\\documents\\vugen\\scripts\\for performance testing\\uc04\\\\combined_UC04.c" 2
...
Action()
{
	...
	lr_think_time(3);
	lr_end_transaction("UC04_TR02_trend_page",2);
	...
	lr_think_time(3);
	lr_end_transaction("UC04_TR03_click_new_report",2);
	...
	lr_think_time(3);
	lr_end_transaction("UC04_TR04_fill_data",2);
	...
	lr_think_time(3);
	lr_end_transaction("UC04_TR05_fill_data_graph_table",2);
	...
	lr_end_transaction("UC04_TR06_change_name",2);
	...
	lr_think_time(3);
	lr_end_transaction("UC04_TR07_save_trend",2);
	...
	lr_think_time(3);
	lr_end_transaction("UC04_TR08_back_to_trends_page",2);
	...
	lr_think_time(6);
	lr_end_transaction("UC04_TR09_pick_created_trend",2);
...
# 5 "c:\\users\\user\\documents\\vugen\\scripts\\for performance testing\\uc04\\\\combined_UC04.c" 2
...
# 6 "c:\\users\\user\\documents\\vugen\\scripts\\for performance testing\\uc04\\\\combined_UC04.c" 2
